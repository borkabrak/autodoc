...
need it.  This file itself is in Markdown.  Surprise -- I've already tricked
you into learning it!  :)
...
Template Toolkit (TTK) is a way for us to get variable data into the pages.
The notation looks like:

    [% projectName %]      --> includes the value of projectName

These available data is specified in two ways:
